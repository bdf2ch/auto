        ...
        if (isAppleTouch) {
          ...
          if (controller) {
            element.on('changeDate', function (ev) {
			  ...
			  if(element.attr("id") == "newRequestStartDate"){
				$("#newRequestEndDate").datepicker('setDate', moment(controller.$viewValue).toDate());
				$("#newRequestEndDate").datepicker('setStartDate', moment(controller.$viewValue).toDate());
				//controller.data.newRequest.endDate = moment(controller.$viewValue).toDate();
			  }
